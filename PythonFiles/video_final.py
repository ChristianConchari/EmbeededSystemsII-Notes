...
cap = cv2.VideoCapture('/home/christian/Descargas/RedRabbitGreenGorilla.mp4')
...
while(1):
    ...
    lower_green = np.array([5,48,0])
    upper_green = np.array([75,117,10])

    lower_red = np.array([255,124,97])
    upper_red = np.array([103,23,10])
